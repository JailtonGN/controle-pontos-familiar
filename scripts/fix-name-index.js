...
async function fixNameIndex() {
    try {
        ...
        console.log('\n🔧 Corrigindo índice do nome das crianças...');
        ...
        // 2. Remover índice name_1 existente (se existir)
        try {
            await Kid.collection.dropIndex('name_1');
            console.log('🗑️ Índice name_1 removido');
        } catch (e) {
            console.log('ℹ️ Índice name_1 não existia ou já foi removido');
        }
        
        // 3. Criar índice único global no nome
        ...
        // 4. Verificar se há conflitos existentes
        ...
        if (duplicates.length > 0) {
            ...
            // 5. Testar a nova validação
            console.log('\n🧪 Testando nova validação...');
            
            const testName = 'Teste Único Global';
